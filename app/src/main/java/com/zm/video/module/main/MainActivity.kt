...
import com.zm.video.module.video.VideoActivity
import com.zm.video.ui.adapter.VideoCoverAdapter
import com.zm.video.ui.widget.UpdateDialogFragment
...
class MainActivity : CommonActivity() {
    ...
    private val mViewModel by lazy {
        ViewModelProviders.of(this, MainViewModelFactory(MainDataSourceRepository())).get(MainViewModel::class.java)
    }
